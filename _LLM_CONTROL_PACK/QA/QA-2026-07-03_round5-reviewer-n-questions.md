...
**Theme (owner-directed):** *What haven't we thought of? What can be added or improved? How do we make this more powerful?* Plus one required outside-the-box question. Owner has specifically requested evaluation of **QR/barcode tag scanning (e.g., galvanizing-rated physical tags)** for automating fabricated-part tracking.
...
Fab shops that galvanize use metal barcode tags that survive the zinc bath (e.g., galvanizing-rated physical tags). If every fabricated part gets one, the app camera becomes the bridge between the physical part and its digital record.
