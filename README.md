...
|---------|-------------|------|
| **Steel Logic** | Shop time tracking with AISC v16.0 shapes and calculators (mobile app) | [Google Play beta](https://play.google.com/store/apps/details?id=com.bluecollarsystems.steellogic) |
